    ...
    <section className="visualization-section" aria-labelledby="monthly-flow-title">
      ...
      <div className="monthly-chart-frame">
        ...
        <div className="monthly-chart-scroll">
          ...
          >
            <defs>
              <pattern id="monthly-guarantee-pattern" width="6" height="6" patternUnits="userSpaceOnUse">
                <rect width="6" height="6" className="chart-pattern-background" />
                <path d="M-1 6 6-1M3 9 9 3" className="chart-pattern-line" />
              </pattern>
            </defs>
            <line className="chart-axis-line" x1="28" y1={baseline} x2={chartWidth - 12} y2={baseline} />
            {months.map((month, index) => {
              ...
              return (
                <g key={month.month}>
                  ...
                  {showTick && (
                    <>
                      <line className="chart-axis-line" x1={x + 8} y1={baseline} x2={x + 8} y2={baseline + 5} />
                      <text className="chart-axis-label" x={x + 8} y={baseline + 20} textAnchor="middle">
