    ...
    <div className="prose-page container">
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            תרשימי SVG עם תוויות קורא מסך בעברית; ערבויות מזוהות גם בדוגמה מפוספסת ומוצגות במסלול
            נפרד מכסף שהתקבל.
          </li>
          <li>
          ...
          <li>טקסט בסיס בגודל 17px, תוכן ארוך בגודל 18px ורצפת גודל של 13px לטקסט משני.</li>
          <li>
            עמודי ההסבר והמילון מחולקים לכרטיסים עם רכיבי details טבעיים, הניתנים להפעלה במקלדת
            ולקריאה לפי סדר המסמך.
          </li>
        ...
        <p>
          בבדיקת Playwright ו־axe של גרסה זו נבדקו 48 תרחישים בגרסאות שולחן עבודה, טאבלט וטלפון, ללא
          ממצאים ברמות serious או critical. בדיקה אוטומטית אינה תחליף לבדיקה אנושית.
        </p>
      </section>
